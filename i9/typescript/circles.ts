...
class Circle {
    ...
    southWest() {
        ...
        return this.adjacent(
            ((this.r * Math.cos(2*Math.PI*(4/6))) + (this.r * Math.cos(Math.PI))),
            -1 * ((this.r * Math.sin(2*Math.PI*(4/6))) + (this.r * Math.sin(Math.PI)))
        );
    }
    ...
    northWest() {
        ...
        // in s3 ... 0,0 is top left of screen ... not top right ...
        return this.adjacent(
            ((this.r * Math.cos(2*Math.PI*(2/6))) + (this.r * Math.cos(Math.PI))),
            -1 * ((this.r * Math.sin(2*Math.PI*(2/6))) + (this.r * Math.sin(Math.PI)))
        );
    }
    ...
    northEast() {
        ...
        // in s3 ... 0,0 is top left of screen ... not top right ...
        return this.adjacent(
            ((this.r * Math.cos(2*Math.PI*(1/6))) + (this.r * Math.cos(0))),
            -1 * ((this.r * Math.sin(2*Math.PI*(1/6))) + (this.r * Math.sin(0)))
        );
    }
    ...
    southEast() {
        ...
        // in s3 ... 0,0 is top left of screen ... not top right ...
        return this.adjacent(
            ((this.r * Math.cos(2*Math.PI*(5/6))) + (this.r * Math.cos(0))),
            -1 * ((this.r * Math.sin(2*Math.PI*(5/6))) + (this.r * Math.sin(0)))
        );
    }
}
